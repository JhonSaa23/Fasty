...
function Login() {
    ...
    return (
        <div className="h-screen flex items-center justify-center bg-principal">
                ...
                <div className={`absolute inset-0 flex transition-transform duration-700 ease-in-out`}>
                    <div className="icon-return top-[18px] left-[1.45rem] absolute z-10">
                        <div onClick={retornarHome} className="return flex items-center pr-[12px] cursor-pointer">
                            ...
                            <p className={`text-[16px] mb-[2px] ${isRegistering ? "text-white delay-[.45s]" : "text-comp"}`}>Regresar</p>
                        </div>
                    </div>
